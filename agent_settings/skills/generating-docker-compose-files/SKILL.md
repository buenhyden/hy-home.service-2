...
description: Generate Docker Compose configurations for multi-container applications with service orchestration, networking, volumes, and environment management. Use when creating Docker Compose files, defining multi-container apps, orchestrating local development environments, or configuring service dependencies with comprehensive automation and best practices.
...
- Setting up service dependencies with Docker
- Creating reproducible development setups
- Managing Docker container networks and volumes
