...
- For scraping tasks, refer to: [9031-web-scraping-std.md](file:///d:/hy-home.SourceCode/Init-Project-Template/.agent/rules/9000-Special/9031-web-scraping-std.md)

## 4. Validation Criteria

- **[VAL-SPEC_CORE-01] Index Integrity**
  - [ ] All `file:///` links in this index point to valid, existing specialized rule files.
